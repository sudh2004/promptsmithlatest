...
function Ecommerce() {
  return (
    <div>
       <Helmet>
        <title>Ecommerce || PromptSmith</title>
      ...
      <div className='Services'>
        ...
        <div className='section sec'>
            ...
            <Typography variant="h2" component="h2" color="primary"  sx={{ml:2}}>Ecommerce</Typography>
        </div>
          {/* heading of the service finish */}

          {/* content of heading start */}
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or Ecommerce, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
