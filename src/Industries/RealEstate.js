    ...
    <div>
      ...
      <div className='Services'>
        ...
        <div className='section sec'>
            ...
            <Typography variant="h2" component="h2" color="primary"  sx={{ml:2}}>Real Estate</Typography>
        </div>
          {/* heading of the service finish */}

          {/* content of heading start */}
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or Real Estate, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
        ...
        <div className='service-content'>
         ...
         Businesses are continuously challenged to do more with less — and content is a great way to drive brand awareness and acquire leads. However, scaling a business’ content output without using more resources is nearly impossible.
          ...
          <div className='img-data'><img src={Aiimg} alt="Ai file" className='images'/></div>
          </div>
