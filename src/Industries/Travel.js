...
function Travel() {
  return (
    <div>
       <Helmet>
        <title>Travel || PromptSmith</title>
      ...
      <div className='Services'>
        ...
        <div className='section sec'>
            ...
            <Typography variant="h2" component="h2" color="primary"  sx={{ml:2}}>Travel</Typography>
        </div>
          {/* heading of the service finish */}

          {/* content of heading start */}
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or Travel, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
