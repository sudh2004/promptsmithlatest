...
function Ai() {
  return (
    <div>
         {/* all the content has been  start */}
       <Helmet>
      ...
      <div className='Services'>
        ...
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or artificial intelligence, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
        ...
        <div className='service-content'>
          ...
          <div className='service-data'>
            ...
            <div className='service-rows-data'>
              <Typography variant="h3" component="h3"sx={{color:"blue"}} className="headings-data">
      ...
      {/* all the content has been finsihed */}
    </div>
  )
}
