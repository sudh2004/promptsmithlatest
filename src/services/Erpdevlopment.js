...
function Erpdevlopment() {
  return (
    <div>
       <Helmet>
        <title>ERP Developmentt || PromptSmith</title>
      ...
      <div className='Services'>
        ...
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or ERP Development, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
