    ...
    <div>
      ...
      <div className='Services'>
        ...
        <div className='section sec'>
            <Typography variant="h2" component="h2" > WebSite </Typography>
        ...
        <div className='conti'>
         <Typography variant="p" component="p"> AI, or WebSite Development, refers to machines that can perform tasks similarly to human.</Typography>
        </div>
        {/* content of heading start */}
